...
export function ServicoRows() {
    ...
    const handleDeleteservice = async (id: string) => {
        try {
            const response = await fetch(`http://localhost:8080/servico/atualizar-status/${id}`, {
                method: 'PUT',
        ...
        <>
            {servicos.map((servico) => (
                <TableRow key={servico.id}>
                                ...
                                <div className="flex gap-2">
                                    <Dialog>
                                        ...
                                        <DialogContent>
                                            ...
                                            <DialogDescription className="flex flex-col gap-1 ml-2">
                                    ...
                                    <AlertDialog>
                                        ...
                                        <AlertDialogContent>
                                            ...
                                            <AlertDialogFooter>
                                                ...
                                                <AlertDialogAction onClick={() => handleDeleteservice(servico.id.toString())}>Excluir</AlertDialogAction>
                                            </AlertDialogFooter>
                                        </AlertDialogContent>
                                    </AlertDialog>
                                </div>
                    ...
                    <TableCell className="font-medium">
                        {servico.status.charAt(0).toUpperCase() + servico.status.slice(1).toLowerCase()}
                    </TableCell>
                </TableRow >
            ))
            }
